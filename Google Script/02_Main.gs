...
function doGet(e) {
  ...
  try {
    ...
    payload.submissionId = params.submissionId || params.id || "";
...
function routeAction(action, payload) {
  ...
  switch (action) {
    ...
    case "facultyDirectory":
      return getFacultyList(payload);

    case "faculty":
    case "getFaculty":
      return getFaculty(payload);

    case "facultyLogin":
    case "login":
      return facultyLogin(payload);
    ...
    case "createAssignmentFacultySelection":
    case "saveAssignmentFacultySelection":
    case "saveSelection":
      return createAssignmentFacultySelection(payload);

    case "getAssignmentFacultySelection":
    case "getSelection":
      return getAssignmentFacultySelection(payload);

    case "getAssignmentControls":
    case "getControls":
    case "assignmentControls":
      return getAssignmentControls(payload);

    case "saveAssignmentControl":
    case "saveControls":
